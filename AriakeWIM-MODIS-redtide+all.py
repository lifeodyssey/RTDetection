...
datalist=glob.glob('A20190905*'+'hdf')
...
for i in range(len(datalist)):
    ...
    ##linewidth：线的宽度
    meridians = np.arange(130,130.7,0.2)
    ...
    cbar.ax.tick_params(labelsize=10)
    #plt.show()
    #plt.savefig('A20191019Rrs555.png')
    ...
    #plt.show
    #plt.savefig('A20191019Rrs555_SS.png')
    ...
    #plt.show
    #plt.savefig('A20191019RBR_Bbpi555.png')
    ...
    #plt.show
    #plt.savefig('A20191019chl_Rrs555.png')
